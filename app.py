...
life_text = "Safety Override available" if st.session_state.lives_used == 0 else "Safety Override used"
st.markdown(f"<div class='score-pill'>Score: {st.session_state.score} &nbsp; | &nbsp; {stage_name(st.session_state.stage)} &nbsp; | &nbsp; Question {st.session_state.q_index + 1}/{QUESTIONS_PER_LEVEL[st.session_state.stage]} &nbsp; | &nbsp; {life_text}</div>", unsafe_allow_html=True)
