...
if view == "host":
    ...
    default_mode_index = 0
mode = st.sidebar.radio("Mode", mode_options, index=default_mode_index)
...
if mode == "Host Screen + Live Leaderboard":
    ...
    st.markdown("<p class='subtitle'>Keep this screen open on your laptop. Students scan the QR code and play from any network/mobile data when the app is deployed online.</p>", unsafe_allow_html=True)
    st.markdown("""
<div class='big-card'>
